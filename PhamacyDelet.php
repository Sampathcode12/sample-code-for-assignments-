...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($searchTerm)) {
        $url = "http://localhost:5268/api/PamacyController1/DeletePharmacy/" . urlencode($searchTerm);
...
<head>
    ...
    <title>Delete Phamacy</title>
</head>
<body>

    <header>
        <h2>Delete Phamacy</h2>
    </header>

    <section class="delete-section">
        <form method="post">
            <input type="text" name="searchTerm" placeholder="Enter Phamacy ID " required>
